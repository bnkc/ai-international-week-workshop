...
class GameState:
    ...
    products: dict = field(
        default_factory=lambda: {
            "Soda": Product("Soda", stock=0, price=0.0, wholesale_cost=0.70),
            "Chips": Product("Chips", stock=0, price=0.0, wholesale_cost=0.45),
            "Candy": Product("Candy", stock=0, price=0.0, wholesale_cost=0.30),
        }
    )
